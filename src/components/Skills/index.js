...
function Skills() {
  ...
  useEffect(() => {
    const scrollingAnimation = () => {
      ...
      //appear
      if (
        Skills.getBoundingClientRect().top < window.innerHeight / 2 ||
        Skills.getBoundingClientRect().bottom > 150
      ) {
      ...
      //reset
      if (
        Skills.getBoundingClientRect().top > window.innerHeight - 100 ||
        Skills.getBoundingClientRect().bottom < 50
      ) {
